...
namespace Neo.ApplicationFramework.Controls.DataItemBrowseControl.Builders
{
    ...
    {
        [Test]
        public async Task TagsAsListAsync()
        {
            // ARRANGE
            ...
            // ACT
            List<BindingSourceDescriptionViewModelBase> result = (await builder
                .BuildListAsync(new[] { tag1, tag2, tag3 }))
                .ToList();
        ...
        [Test]
        public async Task TagsAsTreeAsync()
        {
            // ARRANGE
            BindingSourceDescription tag1 = CreateBindingSourceDescription("Tag3", "Tag3", StringConstants.TagsRoot + "Tag3");
            BindingSourceDescription tag2 = CreateBindingSourceDescription("Tag1", "Tag1", StringConstants.TagsRoot + "Tag1");
            ...
            // ACT
            List<BindingSourceDescriptionViewModelBase> result = (await builder
                .BuildTreeAsync(new[] { tag1, tag2, tag3 }))
                .ToList();
        ...
        [Test]
        public async Task StructuredTagsAsListAsync()
        {
            // ARRANGE
            ...
            // ACT
            List<BindingSourceDescriptionViewModelBase> result = (await builder
                .BuildListAsync(new[] { saw1BeepNumber, saw1MotorSpeed, saw1MotorAcceleration, saw2BeepNumber, saw2MotorSpeed, saw2MotorAcceleration }))
                .ToList();
        ...
        [Test]
        public async Task StructuredTagsAsTreeAsync()
        {
            // ARRANGE
        ...
        [Test]
        public async Task MixtureOfTagsAndStructuredTagsAsListAsync()
        {
            ...
            // ACT
            List<BindingSourceDescriptionViewModelBase> result = (await builder
                .BuildListAsync(new[] { tag2, tag1, saw1BeepNumber }))
                .ToList();
        ...
        [Test]
        public async Task MixtureOfTagsAndStructuredTagsAsTreeAsync()
        {
            BindingSourceDescription tag2 = CreateBindingSourceDescription("Tag2", "Tag2", StringConstants.TagsRoot + "Tag2");
            BindingSourceDescription tag1 = CreateBindingSourceDescription("Tag1", "Tag1", StringConstants.TagsRoot + "Tag1");
            BindingSourceDescription saw1 = CreateBindingSourceDescription("Saw1", "Saw1", StringConstants.TagsRoot + "Saw1");
            ...
            // ACT
            List<BindingSourceDescriptionViewModelBase> result = (await builder
                .BuildTreeAsync(new[] { tag2, tag1, saw1, saw1BeepNumber }))
                .ToList();
        ...
        [Test]
        public async Task AliasAsListAsync()
        {
            ...
            // ACT
            List<BindingSourceDescriptionViewModelBase> result = (await builder
                .BuildListAsync(new[] { alias3, alias1, alias2 }))
                .ToList();
        ...
        [Test]
        public async Task AliasAsTreeAsync()
        {
            BindingSourceDescription alias3 = CreateBindingSourceDescription("Alias3", "#Alias3", "Alias3");
            BindingSourceDescription alias1 = CreateBindingSourceDescription("Alias1", "#Alias1", "Alias1");
            BindingSourceDescription alias2 = CreateBindingSourceDescription("Alias2", "#Alias2", "Alias2");
            ...
            // ACT
            List<BindingSourceDescriptionViewModelBase> result = (await builder
                .BuildTreeAsync(new[] { alias3, alias1, alias2 }))
                .ToList();
        ...
        [Test]
        public async Task MultipleGenerationsAsync()
        {
            // ARRANGE

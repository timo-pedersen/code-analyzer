...
namespace Neo.ApplicationFramework.Controls.Screen.Alias
{
    ...
    public class AliasConfigurationTest
    {
        ...
        public void SetUp()
        {
            m_Container = Substitute.For<IContainer>();
            m_Component = Substitute.For<IComponent>();
        ...
        public void GetAllInstancesIncludesDefaultInstance()
        {
            ...
            var aliasDefinitions = Substitute.For<AliasDefinitions>(new object[] { m_Component });
            aliasDefinitions.CreateDefaultInstance().Returns(defaultInstance);
        ...
        public void SettingDefaultValueUpdatesDataType()
        {
            ...
            var globalDataItemBase = Substitute.For<IGlobalDataItemBase>();
            globalDataItemBase.GlobalDataTypeOrDataTypeIfDefault.Returns(sourceBEDATATYPE);
            m_GlobalReferenceService.GetObject<IGlobalDataItemBase>("").Returns(globalDataItemBase);

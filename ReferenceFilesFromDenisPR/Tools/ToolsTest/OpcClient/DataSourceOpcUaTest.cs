...
namespace Neo.ApplicationFramework.Tools.OpcClient
{
    ...
    public class OpcUaClientServiceDummy : IOpcUaDaClientService
    {
        ...
        public virtual bool Subscribe(uint clientConnectionId, int[] cookies, double[] samplingIntervals, uint count, out int hResult, out bool[] subscribeItemResults)
        {
            hResult = 0;

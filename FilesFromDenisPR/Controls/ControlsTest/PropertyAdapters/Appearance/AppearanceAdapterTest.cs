...
namespace Neo.ApplicationFramework.Controls.PropertyAdapters.Appearance
{
    ...
    public class AppearanceAdapterTest : AppearanceAdapterTestBase
    {
        ...
        public override void SetUp()
        {
            ...
            objectPropertyServiceStub.GetDisplayName(Arg.Any<object>(), Arg.Is("IndicatorColor")).Returns("IndicatorColor");
            objectPropertyServiceStub.GetDisplayName(Arg.Any<object>(), Arg.Is("ScaleColor")).Returns("ScaleColor");

    ...
    public class TrendViewerToolIdeTest
    {
        ...
        private ITrendViewerCrossReferenceItem TrendA
        {
            get
            {
                ...
                return new TrendViewerCrossReferenceItem("Screen2.TrendA", 600, new TimeSpan(1, 0, 0), string.Empty, dataSourceNames, new TimeSpan(1, 0, 0));
            }
        }
        ...
        private ITrendViewerCrossReferenceItem TrendB
        {
            get
            {
                ...
                return new TrendViewerCrossReferenceItem("Screen1.TrendB", 400, new TimeSpan(0, 30, 0), string.Empty, dataSourceNames, new TimeSpan(1, 0, 0));
            }
        }
        ...
        private ITrendViewerCrossReferenceItem TrendC
        {
            get
            {
                ...
                return new TrendViewerCrossReferenceItem("Screen1.TrendC", 1200, new TimeSpan(0, 2, 0), string.Empty, dataSourceNames, new TimeSpan(1, 0, 0));
            }
        }
    }
}

...
namespace Neo.ApplicationFramework.Common.Xaml.Serializer
{
    ...
    public class XamlWriterTest
    {
        ...
        public void DeserializeNeoTextBox()
        {
            ...
            Neo.ApplicationFramework.Controls.TextBox deserializedTextBox = null;
            using (StringReader stringReader = new StringReader(xaml))
            {
                using (XmlTextReader xamlReader = new XmlTextReader(stringReader))
                {
                    ...
                    Assert.IsTrue(obj is Neo.ApplicationFramework.Controls.TextBox, "Deserialized object is of wrong type.");
                    deserializedTextBox = obj as Neo.ApplicationFramework.Controls.TextBox;
                }
            }
        ...
        {
            Assert.That(XamlWriter.IsWPFDefaultNamespace(typeof(Neo.ApplicationFramework.Controls.Button)), Is.False);
        }

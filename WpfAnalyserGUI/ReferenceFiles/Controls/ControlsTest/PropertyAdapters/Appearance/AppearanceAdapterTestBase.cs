...
namespace Neo.ApplicationFramework.Controls.PropertyAdapters.Appearance
{
    ...
    public abstract class AppearanceAdapterTestBase
    {
        ...
        {
            m_ToolManagerMock = TestHelper.CreateAndAddServiceStub<IToolManager>();
            ...
            var targetServiceMock = TestHelper.CreateAndAddServiceStub<ITargetService>();
            targetServiceMock.CurrentTarget.Returns(target);
        }
